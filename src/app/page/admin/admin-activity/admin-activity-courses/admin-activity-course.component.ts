...
export class AdminActivityCourseComponent {
    ...
    initData(): void {
        this.activityService.getAllWithPagination(this.startPage, this.maxPage, this.query, COURSE).subscribe(result => {
    ...
    getData(startPage: number = this.startPage, maxPage: number = this.maxPage, query?: string): void {
        ...
        this.activitiesSub = this.activityService.getAllWithPagination(startPage, maxPage, query, COURSE).subscribe(
            result => {
